          ...
          <div className="flex flex-wrap justify-center gap-3 md:gap-4 mb-12">
            {categories.map((cat) => (
              <button
                ...
                className={`px-6 py-2.5 rounded-full font-bold text-sm md:text-base transition-all duration-300 transform hover:-translate-y-1 transform-gpu will-change-transform antialiased [backface-visibility:hidden] ${
                  activeCategory === cat
