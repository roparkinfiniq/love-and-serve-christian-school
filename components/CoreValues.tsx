    ...
    <section className="py-24 md:py-32 bg-gray-50 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32 bg-white p-10 md:p-12 rounded-[3rem] shadow-[0_15px_40px_-15px_rgba(0,0,0,0.06)] border border-gray-100 flex flex-col items-center text-center relative overflow-hidden group">
            ...
            <div className="relative z-10 w-32 h-32 md:w-40 md:h-40 bg-rose-50/40 p-4 rounded-full flex items-center justify-center mb-8 transition-transform duration-500 hover:scale-105">
              <img 
                src="/logo.png" 
                alt="LSCSI Logo" 
            ...
            <div className="relative z-10">
              <span className="text-[#E11D48] font-black tracking-[0.2em] uppercase text-xs mb-3 block">Our Mission Pillar</span>
              <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-6 leading-tight">Our Core Values</h3>
          ...
          <div className="lg:col-span-7 space-y-6">
            {values.map((val, idx) => (
              <div 
                key={idx} 
                className="bg-white p-6 md:p-8 rounded-3xl shadow-[0_10px_30px_-10px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_40px_-15px_rgba(225,29,72,0.08)] border border-gray-50 hover:border-rose-100/80 transition-all duration-300 flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6 group"
              >
                {/* Number & Icon Container */}
                <div className="flex items-center space-x-4 shrink-0">
                  <span className="text-sm font-black tracking-widest text-[#E11D48]/30 group-hover:text-[#E11D48]/60 transition-colors duration-300">
                    {val.num}
                  </span>
                  <div className={`w-14 h-14 rounded-2xl ${val.color} flex items-center justify-center transition-transform duration-500 group-hover:scale-110 shadow-sm`}>
                ...
                <div className="flex-1">
                  <h4 className="text-xl md:text-2xl font-black text-gray-900 mb-2 transition-colors duration-300 group-hover:text-[#E11D48]">
                    {val.title}
                  </h4>
